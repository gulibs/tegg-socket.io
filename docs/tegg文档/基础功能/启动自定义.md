...
框架提供了以下 [生命周期函数](https://eggjs.org/zh-CN/advanced/loader#life-cycles) 供开发人员处理：
...
如果你的 Egg 框架的生命周期函数是旧版本的，建议你将其升级到类方法模式；详情请查看[升级你的生命周期事件函数](https://eggjs.org/zh-CN/advanced/loader-update)。