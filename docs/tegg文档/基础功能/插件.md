...
- 它包含了 [Service](https://eggjs.org/zh-CN/basics/service)、[中间件](https://eggjs.org/zh-CN/basics/middleware)、[配置](https://eggjs.org/zh-CN/basics/config)、[框架扩展](https://eggjs.org/zh-CN/basics/extend)等等。
- 它没有独立的 [Router](https://eggjs.org/zh-CN/basics/router) 和 [Controller](https://eggjs.org/zh-CN/basics/controller)。
...
- 插件本身可以包含中间件。
- 多个插件可以包装为一个[上层框架](https://eggjs.org/zh-CN/advanced/framework)。
...
同时，我们还支持 `plugin.{env}.js` 的模式，会根据[运行环境](https://eggjs.org/zh-CN/basics/env)加载插件配置。
...
- 关于这两种方式的使用场景，可参见[渐进式开发](https://eggjs.org/zh-CN/intro/progressive)文档。
...
具体的合并规则可以参见[配置](https://eggjs.org/zh-CN/basics/config)。
...
参见文档：[插件开发](https://eggjs.org/zh-CN/advanced/plugin)。