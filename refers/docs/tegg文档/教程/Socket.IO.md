...
**注意：** 如果项目中同时使用了 `@eggjs/redis`，请分别配置，不可共用。
...
详情参考 [Controller](https://eggjs.org/zh-CN/basics/controller) 文档。
...
[egg-socket.io](https://github.com/eggjs/egg-socket.io) 中间件负责处理 socket 连接。
...
![img](https://raw.githubusercontent.com/eggjs/egg/master/docs/assets/socketio-console.png)
