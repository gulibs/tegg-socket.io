...
本教程只是一对一地讲了替换方法，便于开发者们快速上手进行替换。 若想要具体了解整个 Loader 原理以及生命周期的完整函数版本，请参考《[加载器](https://eggjs.org/zh-CN/advanced/loader)》和《[启动自定义](https://eggjs.org/zh-CN/basics/app-start)》两篇文章。