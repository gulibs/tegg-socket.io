...
## Purpose
This specification defines the namespace management system for the `@eggjs/tegg-socket.io` plugin, including configuration-based namespace setup with per-namespace middleware. It ensures that multiple Socket.IO namespaces can be configured and initialized with independent middleware chains.
## Requirements
